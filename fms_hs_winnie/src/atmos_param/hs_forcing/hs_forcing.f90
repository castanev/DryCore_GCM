...
!-----------------------------------------------------------------------------------
   ...
   character(len=256) :: drag_file='drag_file'            ! Name of drag file
...
! character(len=128) :: drag_file_name
! CALL getenv('drag_file_name', drag_file_name)
...
! $PATH is the location of the surface momentum damping data file
      ! open(99,file=drag_file_name)
      open(99,file='/home/castanev/DryCore_Wu/data/drag.txt')
      do ikf=1,128
        read(99,"(64F6.2)") kf(ikf,:)
      enddo
      close(99) 
